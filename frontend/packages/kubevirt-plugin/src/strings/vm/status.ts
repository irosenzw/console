...
export const MODAL_RESTART_IS_REQUIRED =
  'The changes you are making require this virtual machine to be updated. You can clear these changes and keep the current settings as seen in the VM Details page';
